...
<!-- devlog is not 100% up to date disclaimer -->
# Development Log
This development log is a work in progress and may not reflect the latest changes or features in Aspira (at the time of writing this, I made several changes that are not yet documented here).

I'm working on maybe turning this into a blog post series later, but for now, this DEVLOG.md serves as a "reminder" journal of the design decisions, challenges, and milestones in building Aspira, even though I didn't document everything in real-time. I need to tell the full story of this project properly (because oh boy, the starting from scratch part was quite the adventure).
