...
public class SEETest {
    ...
    static String rawTestString = "6k1/1pp4p/p1pb4/6q1/3P1pRr/2P4P/PP1Br1P1/5RKN w - - | f1f4 | -100 | P - R + B\n"
    ...
    public void testSEE() {
        ...
        for (String line : rawTestString.split("\n")) {
            ...
            if (!ok || ko) {
                ...
                System.out.println("  seeGE(expected)   = " + ok);
                System.out.println("  seeGE(expected+1) = " + ko);
                System.out.println();
            } else {
                System.out.println("OK: " + fen + " | " + moveStr + " | " + expected);
            }
