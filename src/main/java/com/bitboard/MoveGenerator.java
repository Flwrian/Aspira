    ...
    public static PackedMoveList generatePseudoLegalMoves(BitBoard board) {
        ...
        while (pawns != 0L) {
            ...
            while (pawnMoves != 0L) {
                ...
                int capturedPiece = board.getPieceAt(to);
                ...
                if (capturedPiece != BitBoard.EMPTY) {
                    ...
                    score = mvvLva[attackerType][capturedPiece];
                } else {
                    score = 0;
                }
        ...
        while (knights != 0L) {
            ...
            while (knightMoves != 0L) {
                ...
                if (captured != BitBoard.EMPTY) {
                    ...
                    score = mvvLva[attackerType][captured];
                } else {
                    score = 0;
                }
        ...
        while (pawns != 0L) {
            ...
            while (pawnMoves != 0L) {
                ...
                if ((move & board.bitboard) != 0L) {
                    ...
                    // MVV-LVA calculation
                    int attackerType = BitBoard.PAWN;
                    int capturedType = capturedPiece;
